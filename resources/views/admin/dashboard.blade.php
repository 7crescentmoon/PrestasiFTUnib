                        ...
                        <div class="col-lg-4 col-md-4 order-1">
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-6">
                                    <div class="card">
                                        <p class="text-center p-1">Jumlah <span class="text-primary fw-bold">Mahasiswa</span> Berprestasi</p>
                                        <div class="">
                                            ...
                                            <div class="text-center">
                                                <p class="fs-1 text-primary">{{ $laki_laki }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 col-6">
                                    <div class="card">
                                        <p class="text-center p-1">Jumlah <span class="text-warning fw-bold">Mahasiswi</span> Berprestasi</p>
                                        <div class="">
                                            <div class="text-center mb-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                    viewBox="0 0 24 24"
                                            ...
                                            <div class="text-center">
                                                <p class="fs-1 text-warning">{{ $perempuan }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
